...
require_file "$PACKAGE_DIR/Sources/CatalinaPerformance/VisualPerformancePanelController.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformance/VisualPerformanceDashboardAdapter.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformance/LegacyUIResponsivenessRecovery.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformanceVisualPerformanceCore/CatalinaVisualPerformanceCatalog.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformanceVisualPerformanceCore/VisualPerformanceCoordinator.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformanceVisualPerformanceCore/VisualPerformanceModels.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformanceVisualPerformanceCore/VisualPerformanceRestoreDecision.swift"
require_file "$PACKAGE_DIR/Sources/CatalinaPerformanceVisualPerformanceCore/VisualPerformanceStateStore.swift"
